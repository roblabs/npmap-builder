    ...
    _click: function() {
      ...
      if (errors.length) {
        ...
        $layers.append($([
          ...
          '<span><img src="img/change-marker.png" style="cursor:pointer;float:left;" onclick="Builder._handlers.layerChangeMarkerOnClick(NPMap.overlays[' + index + ']);return false;"></span>',
          '</div></li>'
        ].join('')));
